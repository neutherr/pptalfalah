...
<div class="pt-32 pb-24 bg-surface min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl shadow-sm hover:shadow-xl transition-shadow duration-500 p-8 md:p-12 lg:p-16 border border-outline-variant/20">
            <div class="prose prose-lg prose-emerald max-w-none text-on-surface-variant font-body leading-relaxed prose-headings:font-headline prose-headings:text-primary prose-a:text-primary hover:prose-a:text-primary-dark prose-img:rounded-2xl prose-img:shadow-lg prose-p:mb-6 prose-li:mb-2">
                {!! $page->content !!}
            </div>
        </div>
