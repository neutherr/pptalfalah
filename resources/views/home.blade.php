...
@section('content')
    ...
    @endphp
    <section class="relative min-h-screen flex items-center overflow-hidden bg-primary" x-data="{ activeSlide: 0, 
                        init() {
                               setInterval(() => {
            ...
            @foreach($displaySlides as $index => $slide)
                ...
                <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out"
                    ...
                    <img alt="{{ $imgTitle }}"
                        ...
                        src="{{ $imgSrc }}" loading="{{ $loop->first ? 'eager' : 'lazy' }}" />
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 w-full relative z-10 py-20 lg:py-32">
            <div class="max-w-3xl">
                <h1
                    class="font-hero text-3xl sm:text-4xl lg:text-6xl font-extrabold text-white [&_span]:text-inherit leading-[1.2] mb-4 sm:mb-6 animate-on-scroll">
                    {!! $settings['vision_headline'] ?? 'Menanam Iman, Menuai Kemandirian<br/>Pesantren Tahfidz, Informatika & Agribisnis Terpadu' !!}
                </h1>
                <p class="text-base sm:text-lg lg:text-xl text-emerald-50/80 max-w-xl mb-8 sm:mb-10 leading-relaxed font-medium animate-on-scroll"
                ...
                <div class="flex flex-col sm:flex-row flex-wrap gap-4">
                    ...
                    @if(!empty($settings['active_brochure_url']))
                        <a class="px-6 py-3 sm:px-8 sm:py-4 bg-secondary-container text-on-secondary-container rounded-full font-bold text-sm hover:bg-secondary-fixed transition-all shadow-xl flex items-center justify-center gap-2 text-center"
                            href="{{ $settings['active_brochure_url'] }}" target="_blank" id="click_download_brochure_home"
                            download>
                    ...
                    @else
                        <button
                            class="px-6 py-3 sm:px-8 sm:py-4 bg-secondary-container text-on-secondary-container rounded-full font-bold text-sm hover:bg-secondary-fixed transition-all shadow-xl flex items-center justify-center gap-2 text-center w-full sm:w-auto"
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    ...
                    <h2
                        class="font-headline text-3xl sm:text-4xl lg:text-5xl font-extrabold text-primary leading-tight mb-6">
                    ...
                    <div class="space-y-6 text-on-surface-variant text-lg leading-relaxed">
                        <p>
                            Berawal dari kesadaran, idealisme, dan semangat untuk melahirkan generasi muslim yang mandiri
                            dan tangguh, kami memadukan generasi Qur'ani dengan kemandirian ekologi. Di atas keyakinan bahwa
                            ketahanan umat berakar pada ketahanan pangan dan fondasi tauhid yang kuat, maka di Jonggol Utara
                            ini dibangun sebuah rintisan lembaga pendidikan terpadu: <strong>Pondok Pesantren Tahfidz
                                Al-Falah</strong>.
                        </p>
                        <p>
                            <strong>Kenapa Harus Memilih Al-Falah Boarding School?</strong><br>
                            Pondok Pesantren Tahfidz Al-Falah, didirikan oleh para praktisi bisnis, hafizh Qur'an dan juga
                            aktivis dakwah, sangat memahami betul tentang pilihan arah dan jenjang pendidikan putra Anda
                            saat ini. Oleh karena itu, kami telah mempersiapkan dengan sangat teliti, detail, dan menyeluruh
                            4 pilar keunggulan pembelajaran kami, yaitu:
                            <span class="block mt-3 font-semibold text-primary">
                                1. Tahfidz Al-Qur'an 30 Juz<br>
                                2. Pendidikan Boarding School Menyeluruh<br>
                                3. Program Keahlian Agribisnis Terpadu<br>
                                4. Program Keahlian Informatika
                            </span>
                        </p>
                    </div>
                </div>
    ...
    <section class="py-12 lg:py-16 relative overflow-hidden bg-surface">
        <div class="absolute inset-0"
            style="background-image: url('{{ asset('assets/backgroundpattern.jpg') }}'); background-repeat: no-repeat; background-size: cover; background-position: center; opacity: 0.15;">
        </div>
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center mb-16 max-w-5xl mx-auto">
                ...
                <h2
                    class="font-headline text-3xl sm:text-4xl lg:text-5xl font-black text-primary leading-tight tracking-tighter mb-6">
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="space-y-8">
                    @foreach($missions as $mission)
                        <div
                            class="group flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-8 pb-8 border-b border-outline-variant/10 last:border-0">
                            <div class="shrink-0 flex flex-col items-center">
                                <div
                                    class="text-secondary/20 font-body font-black text-4xl transition-colors group-hover:text-secondary/40">
                                    {{ $mission['number'] }}
                                </div>
                                <div class="w-1 h-6 bg-secondary/10 rounded-full group-hover:bg-secondary/30 transition-all">
                                </div>
                            </div>
                            <div class="text-center md:text-left">
                                <h3
                                    class="font-body text-xl font-bold text-primary mb-2 group-hover:text-secondary transition-colors">
                                    {{ $mission['title'] }}
                                </h3>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                @forelse($programs as $program)
                    <a href="{{ $program->slug ? route('programs.show', $program->slug) : '#' }}"
                        class="bg-surface-container-lowest rounded-[2.5rem] shadow-sm hover:shadow-2xl transition-all duration-500 group overflow-hidden flex flex-col hover:-translate-y-2">
                        ...
                        <div class="p-10 pt-8 flex-grow flex flex-col">
                            <h3
                                class="font-body text-2xl font-bold text-primary mb-4 group-hover:text-primary-dark transition-colors">
                                {{ $program->title }}
                            </h3>
                                ...
                                <ul class="space-y-3 text-sm font-semibold text-primary/80 mb-6">
                                    @foreach(array_slice($program->bullet_points, 0, 3) as $bullet)
                                        <li class="flex items-center gap-2">
                                            ...
                                            <span
                                                class="line-clamp-1">{{ is_array($bullet) ? ($bullet['point'] ?? '') : $bullet }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                            @endif
                            <div
                                class="pt-4 border-t border-outline-variant/30 flex justify-between items-center text-primary font-bold">
                        ...
                        @if($firstWave)
                            <div class="p-6 lg:p-8 bg-primary rounded-3xl text-white shadow-2xl">
                                <div class="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        <p class="text-xs font-bold uppercase tracking-widest text-primary-fixed">
                                            {{ $firstWave->name }}
                                        </p>
                                        <p class="text-xl font-bold">
                                            {{ $firstWave->registration_start->format('d M') }} -
                                            {{ $firstWave->registration_end->format('d M Y') }}
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="lg:col-span-3 space-y-8">
                        @foreach([
                            ...
                            <div class="flex gap-6 items-start relative {{ !$loop->last ? 'pb-8' : '' }} group">
                                ...
                                @endif
                                <div
                                    class="w-12 h-12 rounded-full bg-surface-container-highest flex items-center justify-center shrink-0 border-4 border-surface group-hover:bg-primary transition-colors">
                                    <span
                                        class="text-lg font-bold text-primary group-hover:text-white">{{ str_pad($index + 1, 2, '0', STR_PAD_LEFT) }}</span>
                                </div>
                                <div>
    ...
    <section class="py-12 lg:py-24 bg-white relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div class="text-center mb-16">
                <h2 class="font-headline text-3xl lg:text-4xl font-extrabold text-primary mb-4">Berita & Artikel Terkini
                </h2>
                <p class="text-on-surface-variant max-w-2xl mx-auto">Tetap terhubung dengan kegiatan dan prestasi terbaru
                    kami sebagai wujud nyata dedikasi dalam mencetak generasi unggul.</p>
            </div>

            <div class="grid md:grid-cols-3 gap-8 mb-16">
                @forelse($latestArticles as $article)
                    <article
                        class="group bg-surface-container-low rounded-[2rem] overflow-hidden border border-outline-variant/30 flex flex-col transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1">
                        ...
                        <div class="p-8 flex-grow flex flex-col">
                            <div
                                class="flex items-center gap-3 text-xs text-on-surface-variant mb-4 font-semibold uppercase tracking-wider">
                                <span>{{ $article->published_at?->format('d M Y') }}</span>
                                <span class="w-1 h-1 bg-outline rounded-full"></span>
                                <span>{{ $article->author?->name ?? 'Admin' }}</span>
                            </div>
                            <h3
                                class="font-body text-xl font-bold text-primary mb-3 leading-tight group-hover:text-secondary transition-colors">
                                {{ $article->title }}
                            </h3>
    ...
    <section class="py-12 lg:py-24 bg-surface-container-low overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative">
            <div class="text-center mb-16">
                <h2 class="font-headline text-3xl lg:text-4xl font-extrabold text-primary mb-4 tracking-tight">Galeri
                    Kegiatan & Fasilitas</h2>
                <div class="w-24 h-1.5 bg-secondary mx-auto rounded-full"></div>
            </div>
            ...
            <div class="relative group" x-data="{
                ...
                <div x-ref="slider"
                    class="flex overflow-x-auto snap-x snap-mandatory scroll-smooth no-scrollbar gap-6 pb-12">
                        ...
                        <div class="min-w-full md:min-w-[70%] snap-center shrink-0">
                            <div class="relative h-[350px] lg:h-[500px] rounded-[2rem] overflow-hidden group/slide shadow-2xl">
                                <img alt="{{ $item->title }}"
                                    ...
                                    loading="lazy" />
                                <div
                                    class="absolute inset-0 bg-gradient-to-t from-primary/90 via-transparent to-transparent flex flex-col justify-end p-12">
                                    @if($item->category)
                                        <span
                                            class="text-secondary-fixed font-semibold text-sm mb-2">{{ $item->category->name }}</span>
                                    @endif
                ...
                {{-- Navigation Arrows --}}
                <button
                    class="absolute left-4 top-1/2 -translate-y-1/2 w-14 h-14 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center text-white transition-all shadow-xl border border-white/20"
                    @click="scrollPrev()" x-show="active > 0" x-transition aria-label="Slide sebelumnya">
                    <span class="material-symbols-outlined">chevron_left</span>
                </button>
                <button
                    class="absolute right-4 top-1/2 -translate-y-1/2 w-14 h-14 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center text-white transition-all shadow-xl border border-white/20"
                    @click="scrollNext()" x-show="active < total - 1" x-transition aria-label="Slide berikutnya">
